...
def get_user_input():
    ...
    output_file_name = input("Introduceți numele fișierului pentru salvare (fără extensie): ") + ".txt"
    return file_name.strip(), document_number.strip(), output_file_name.strip()

# Read content from the .docx file
file_name, document_number, output_file_name = get_user_input()
...
if hasattr(completion, 'choices') and completion.choices:
    ...
    print(f"Rezumatul a fost salvat în fișierul: {output_file_name}")
else:
